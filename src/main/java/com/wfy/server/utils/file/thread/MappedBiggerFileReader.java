 ...
 *
 * @author weifeiyu
 * @version Id: MappedBiggerFileReader.java, v 0.1 2017/12/21 21:10 fuck Exp $$
 */
public class MappedBiggerFileReader {
    ...
    public static void main(String[] args) throws IOException {
        MappedBiggerFileReader reader = new MappedBiggerFileReader("E:/Weihui/fund_netValue/fund_nav.txt", 65536);
